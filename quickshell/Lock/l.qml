    ...
    WlSessionLockSurface {
        ...
        Rectangle {
            ...
            Image {
                id: wallpaper
                anchors.fill: parent
                source: root.currentWallpaper !== "" ? "file://" + root.wallpaperDir + root.currentWallpaper : "" //"file://" + Quickshell.env("HOME") + "/.config/wallpaper/"
                ...
                visible: true // Hidden so MultiEffect can render the blurred version
            }
