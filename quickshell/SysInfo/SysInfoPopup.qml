...
PanelWindow {
    ...
    WlrLayershell.namespace:     "Yajat-stats"
                        ...
                        Process { id:kernelProc; command:["uname","-r"]
                            ...
                            Process { id:osProc; command:["sh","-c","grep PRETTY_NAME /etc/os-release | sed 's/PRETTY_NAME=//;s/\"//g;s/—//g;s/ - //g'"]
                                ...
                                Item { anchors.fill:parent; opacity:0.96
                                    Rectangle { anchors.fill:parent; color: Colors.surface/*"#282828"*/; radius:10
                                        Rectangle { anchors.top:parent.top; anchors.left:parent.left; anchors.right:parent.right; height:10; color:Colors.surface/*"#282828"*/; radius: 18 }
                                    }
                                }
                                ...
                                ColumnLayout {
                                    ...
                                    // ── ECG ───────────────────────────────────────────────────────
                                    Rectangle { Layout.fillWidth:true; height:168; radius:10; color:Colors.module//"#3c3836"
                                        Repeater { model:2; Rectangle { x:10; y:56+index*54; width:parent.width-20; height:1; color: Colors.module_hover/*"#504945"*/; opacity:0.25 } }
                                        Column {
                                            anchors.left:      parent.left
                                            anchors.right:     parent.right
                                            anchors.top:       parent.top
                                            ...
                                            Item { width:parent.width; height:54
                                                Rectangle{x:0;anchors.verticalCenter:parent.verticalCenter;width:30;height:30;radius:6;color: Colors.module_hover/*"#504945"*/
                                                    Image{anchors.centerIn:parent;width:16;height:16;smooth:true;source:sp.ico(sp.i_cpu,"%23ebdbb2",16);layer.enabled: true;layer.effect: ColorOverlay {color:Colors.surfacefg}}}
                                                    Text{x:40;anchors.verticalCenter:parent.verticalCenter;text:Math.round(SystemStats.cpuPct)+"%";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium;width:46}
                                            ...
                                            Item { width:parent.width; height:54
                                                Rectangle{x:0;anchors.verticalCenter:parent.verticalCenter;width:30;height:30;radius:6;color: Colors.module_hover/*"#504945"*/
                                                    Image{anchors.centerIn:parent;width:16;height:16;smooth:true;source:sp.ico(sp.i_therm,"%23ebdbb2",16);layer.enabled: true;layer.effect: ColorOverlay {color:Colors.surfacefg}}}
                                                    Text{x:40;anchors.verticalCenter:parent.verticalCenter;text:SystemStats.cpuTemp>0?Math.round(SystemStats.cpuTemp)+"°":"--°";color:Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium;width:46}
                                            ...
                                            Item { width:parent.width; height:54
                                                Rectangle{x:0;anchors.verticalCenter:parent.verticalCenter;width:30;height:30;radius:6;color: Colors.module_hover/*"#504945"*/
                                                    Image{anchors.centerIn:parent;width:16;height:16;smooth:true;source:sp.ico(sp.i_ram,"%23ebdbb2",16);layer.enabled: true;layer.effect: ColorOverlay {color:Colors.surfacefg}}}
                                                    Text{x:40;anchors.verticalCenter:parent.verticalCenter;text:SystemStats.ramGb.toFixed(1)+"G";color:Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium;width:46}
                                    ...
                                    // ── Network ───────────────────────────────────────────────────
                                    Rectangle { Layout.fillWidth:true; height:64; radius:10; color: Colors.module/*"#3c3836"*/
                                        Item {
                                            anchors.fill: parent
                                            ...
                                            Column {
                                                ...
                                                Row { spacing:6
                                                    ...
                                                    Text{text:sp.fmtNet(sp.rxKb);color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium;anchors.verticalCenter:parent.verticalCenter}
                                                }
                                                Text{text:"Download";color:Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:10}
                                            }

                                            // Separator
                                            Rectangle { width:1; height:40; color: Colors.outline/*"#504945"*/; opacity:0.4; anchors.centerIn:parent }
                                            ...
                                            Column {
                                                ...
                                                Row { spacing:6; layoutDirection:Qt.RightToLeft
                                                    ...
                                                    Text{text:sp.fmtNet(sp.txKb);color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium;anchors.verticalCenter:parent.verticalCenter}
                                                }
                                                Text{text:"Upload";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:11;anchors.right:parent.right}
                                            }
                                        }
                                    }
                                    ...
                                    Repeater {
                                        ...
                                        delegate: Rectangle {
                                            ...
                                            Layout.fillWidth: true; height: 62; radius: 10; color: Colors.module/*"#3c3836"*/
                                            Item {
                                                anchors.fill: parent
                                                ...
                                                Row {
                                                    ...
                                                    Image { width:13; height:13; smooth:true; anchors.verticalCenter:parent.verticalCenter
                                                        source: sp.ico(sp.i_disk, "%23a89984", 13);layer.enabled: true;layer.effect: ColorOverlay {color:Colors.surfacefg} }
                                                        Text { text: modelData.mount; color: Colors.surfacefg/*"#ebdbb2"*/; font.family:"Google Sans"; font.pixelSize:13; font.weight:Font.Medium; anchors.verticalCenter:parent.verticalCenter }
                                                        Item { width:1; height:1; Layout.fillWidth:true }
                                                        Text { text: modelData.used+" / "+modelData.total; color:Colors.surfacefg/*"#ebdbb2"*/; font.family:"Google Sans"; font.pixelSize:12; anchors.verticalCenter:parent.verticalCenter }
                                                }
                                                ...
                                                Rectangle {
                                                    ...
                                                    anchors.left: parent.left
                                                    anchors.right: parent.right
                                                    height: 6; radius: 3; color: Colors.surfacea/*"#504945"*/
                                                    Rectangle {
                                                        width: parent.width * Math.min(modelData.pct, 100) / 100
                                                        height: parent.height; radius: 3; color: Colors.primary/*"#a89984"*/
                                                    ...
                                                    Text { anchors.right:parent.right; anchors.rightMargin:4; anchors.verticalCenter:parent.verticalCenter
                                                        text: modelData.pct+"%"; color: Colors.surfacefg/*"#ebdbb2"*/; font.family:"Google Sans"; font.pixelSize:10; font.weight:Font.Bold }
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    // ── Load avg ──────────────────────────────────────────────────
                                    Rectangle { Layout.fillWidth:true; height:58; radius:10; color: Colors.module/*"#3c3836"*/
                                        Item {
                                            anchors.fill: parent
                                            anchors.leftMargin: 14
                                            anchors.rightMargin: 14
                                            ...
                                            Column {
                                                ...
                                                anchors.verticalCenter: parent.verticalCenter
                                                spacing: 4
                                                Text{text:"Load Average";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:10}
                                                Row { spacing:14
                                                    Column { spacing:1
                                                        Text{text:sp.loadAvg1.toFixed(2);color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium}
                                                        Text{text:"1 min";color: Colors.outline/*"#a89984"*/;font.family:"Google Sans";font.pixelSize:10}
                                                    }
                                                    Column { spacing:1
                                                        Text{text:sp.loadAvg5.toFixed(2);color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16}
                                                        Text{text:"5 min";color: Colors.outline/*"#a89984"*/;font.family:"Google Sans";font.pixelSize:10}
                                                    }
                                                    Column { spacing:1
                                                        Text{text:sp.loadAvg15.toFixed(2);color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16}
                                                        Text{text:"15 min";color: Colors.outline/*"#a89984"*/;font.family:"Google Sans";font.pixelSize:10}
                                                    }
                                                }
                                            }
                                            ...
                                            Column {
                                                ...
                                                anchors.verticalCenter: parent.verticalCenter
                                                spacing: 4
                                                Text{text:"Uptime";color: Colors.outline/*"#665c54"*/;font.family:"Google Sans";font.pixelSize:11;anchors.right:parent.right}
                                                Text{text:sp.uptimeStr||"";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium}
                                            }
                                        }
                                    }

                                    // ── Host ──────────────────────────────────────────────────────
                                    Rectangle { Layout.fillWidth:true; height:62; radius:10; color: Colors.module/*"#3c3836"*/
                                        Item {
                                            anchors.fill: parent
                                            anchors.leftMargin: 14
                                            anchors.rightMargin: 14
                                            ...
                                            Column {
                                                ...
                                                anchors.verticalCenter: parent.verticalCenter
                                                spacing: 3
                                                Text{text:sp.hostname||"";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:16;font.weight:Font.Medium}
                                                Text{text:sp.osName||"Linux";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:13}
                                            }
                                            ...
                                            Column {
                                                ...
                                                anchors.verticalCenter: parent.verticalCenter
                                                spacing: 3
                                                Text{text:"Kernel";color: Colors.outline/*"#665c54"*/;font.family:"Google Sans";font.pixelSize:11;anchors.right:parent.right}
                                                Text{text:sp.kernelVer||"";color: Colors.surfacefg/*"#ebdbb2"*/;font.family:"Google Sans";font.pixelSize:15;font.weight:Font.Medium}
                                            }
                                        }
                                    }
                                }
