...
PanelWindow {
    ...
    // FIX: Restrict input region so hidden/empty overlay space doesn't block clicks
    mask: Region {
    ...
    Item {
        ...
        Rectangle {
            anchors.fill: parent
            color: Colors.surface; radius: 18
        }
    }
    ...
    ColumnLayout {
        ...
        Rectangle {
            Layout.fillWidth: true; height: 80; radius: 16; color: Colors.module
        ...
        Rectangle {
            ...
            id: calCard
            height: 348; radius: 8; color: Colors.module
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        color: Colors.surfacefg; font.family: mainFont
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                color: isToday ? Colors.primary : (dMa.containsMouse && valid ? Colors.module_hover : "transparent")
                                Behavior on color { ColorAnimation { duration: 80 } }
                            }
                            ...
                            Text {
                                ...
                                color: isToday ? Colors.primaryfg : Colors.backgroundfg
