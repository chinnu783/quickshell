...
PanelWindow {
    ...
    // Restrict mask ONLY to the visual bgPanel when open
    mask: Region {
        ...
        ColumnLayout {
            ...
            ScriptModel {
                ...
                values: {
                    ...
                    return allEntries.filter(d => d && d.name && d.name.toLowerCase().includes(q));
                }
            }
            ...
            ListView {
                ...
                currentIndex: (filtered.values && filtered.values.length > 0) ? 0 : -1
